...
{
    internal sealed class Neeko : Champion
    {
        public Neeko()
        {
        ...
        {
            MenuManager.AddTab(new Tab($"SIXAIO - {nameof(Neeko)}"));
            ...
            RSettings.AddItem(new Counter() { Title = "R Enemies Closer Than", MinValue = 50, MaxValue = 600, Value = 550, ValueFrequency = 50 });
